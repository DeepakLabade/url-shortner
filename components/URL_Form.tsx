  ...
  return (
    <div>
      <div className="flex w-full justify-center text-center">
        <h1 className="text-2xl flex items-center font-bold ">URL Shortner</h1>
      </div>
        ...
        {shortURL && (
          <div className="border border-slate-300 rounded flex items-center justify-between">
            <Link href={shortURL} target="_blank" rel="noopener noreferrer">
              <div className="px-2">{shortURL}</div>
            </Link>
            <div
              className={`transition-colors duration-300 borderl-1 ${
                isCopied ? "bg-green-500" : "bg-slate-300"
              }`}
            >
              <button
